...
-- -----------------------------------------------------
-- Table "RP_Raster"."RP_RasterplanAenderung"
-- -----------------------------------------------------
CREATE  TABLE  "RP_Raster"."RP_RasterplanAenderung" (
  "gid" BIGINT NOT NULL ,
  ...
  "datumDesInkrafttretens" DATE NULL ,
  PRIMARY KEY ("gid") ,
  CONSTRAINT "fk_RP_RasterplanAenderung_parent"
    FOREIGN KEY ("gid" )
...
GRANT SELECT ON TABLE "RP_Raster"."RP_RasterplanAenderung" TO xp_gast;
GRANT ALL ON TABLE "RP_Raster"."RP_RasterplanAenderung" TO rp_user;
CREATE INDEX "RP_RasterplanAenderung_gidx" ON "RP_Raster"."RP_RasterplanAenderung" using gist ("geltungsbereichAenderung");
COMMENT ON TABLE "RP_Raster"."RP_RasterplanAenderung" IS '';
COMMENT ON COLUMN "RP_Raster"."RP_RasterplanAenderung"."gid" IS 'Primärschlüssel, wird automatisch ausgefüllt!';
COMMENT ON COLUMN "RP_Raster"."RP_RasterplanAenderung"."aufstellungbeschlussDatum" IS 'Beginn der öffentlichen Auslegung';
COMMENT ON COLUMN "RP_Raster"."RP_RasterplanAenderung"."auslegungsStartDatum" IS 'Beginn der öffentlichen Auslegung.';
COMMENT ON COLUMN "RP_Raster"."RP_RasterplanAenderung"."auslegungsEndDatum" IS 'Ende der öffentlichen Auslegung.';
COMMENT ON COLUMN "RP_Raster"."RP_RasterplanAenderung"."traegerbeteiligungsStartDatum" IS 'Beginn der Beteiligung der Träger öffentlicher Belange';
COMMENT ON COLUMN "RP_Raster"."RP_RasterplanAenderung"."traegerbeteiligungsEndDatum" IS 'Ende der Beteiligung der Träger öffentlicher Belange.';
COMMENT ON COLUMN "RP_Raster"."RP_RasterplanAenderung"."aenderungenBisDatum" IS 'Datum, bis zu dem Änderungen des Plans berücksichtigt wurden.';
COMMENT ON COLUMN "RP_Raster"."RP_RasterplanAenderung"."entwurfsbeschlussDatum" IS 'Datum des Entwurfsbeschlusses.';
COMMENT ON COLUMN "RP_Raster"."RP_RasterplanAenderung"."satzungsbeschlussDatum" IS 'Datum des Satzungsbeschlusses.';
COMMENT ON COLUMN "RP_Raster"."RP_RasterplanAenderung"."datumDesInkrafttretens" IS 'Datum des Inkrafttretens.';
CREATE TRIGGER "change_to_RP_RasterplanAenderung" BEFORE INSERT OR UPDATE ON "RP_Raster"."RP_RasterplanAenderung" FOR EACH ROW EXECUTE PROCEDURE "XP_Raster"."child_of_XP_RasterplanAenderung"();
CREATE TRIGGER "delete_RP_RasterplanAenderung" AFTER DELETE ON "RP_Raster"."RP_RasterplanAenderung" FOR EACH ROW EXECUTE PROCEDURE "XP_Raster"."child_of_XP_RasterplanAenderung"();

-- -----------------------------------------------------
-- Table "RP_Basisobjekte"."RP_Bereich_rasterAenderung"
-- -----------------------------------------------------
CREATE  TABLE  "RP_Basisobjekte"."RP_Bereich_rasterAenderung" (
  "RP_Bereich_gid" BIGINT NOT NULL ,
  "rasterAenderung" BIGINT NOT NULL ,
  PRIMARY KEY ("RP_Bereich_gid", "rasterAenderung") ,
  CONSTRAINT "fk_rasterAenderung_RP_Bereich"
    FOREIGN KEY ("RP_Bereich_gid" )
    REFERENCES "RP_Basisobjekte"."RP_Bereich" ("gid" )
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT "fk_rasterAenderung_RP_RasterplanAenderung"
    FOREIGN KEY ("rasterAenderung" )
    REFERENCES "RP_Raster"."RP_RasterplanAenderung" ("gid" )
    ON DELETE CASCADE
    ON UPDATE CASCADE);

CREATE INDEX "idx_fk_rasterAenderung_RP_Bereich" ON "RP_Basisobjekte"."RP_Bereich_rasterAenderung" ("RP_Bereich_gid") ;
CREATE INDEX "idx_fk_rasterAenderung_RP_RasterplanAenderung" ON "RP_Basisobjekte"."RP_Bereich_rasterAenderung" ("rasterAenderung") ;
GRANT SELECT ON TABLE "RP_Basisobjekte"."RP_Bereich_rasterAenderung" TO xp_gast;
GRANT ALL ON TABLE "RP_Basisobjekte"."RP_Bereich_rasterAenderung" TO rp_user;
