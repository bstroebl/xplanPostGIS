...
-- editierende Rolle für LP_Fachschema_FPlan
CREATE ROLE lp_user
...
CREATE  TABLE  "LP_Basisobjekte"."LP_Plan" (
  ...
  "tOeBbeteiligungsDatum" DATE NULL ,
  "oeffentlichkeitsbeteiligungDatum" DATE NULL ,
...
CREATE  TABLE  "LP_Raster"."LP_RasterplanAenderung" (
  ...
  "sonstVerfahrensDatum" DATE NULL ,
  PRIMARY KEY ("gid") ,
  CONSTRAINT "fk_LP_RasterplanAenderung_parent"
    FOREIGN KEY ("gid" )
...
GRANT SELECT ON TABLE "LP_Raster"."LP_RasterplanAenderung" TO xp_gast;
GRANT ALL ON TABLE "LP_Raster"."LP_RasterplanAenderung" TO lp_user;
CREATE INDEX "LP_RasterplanAenderung_gidx" ON "LP_Raster"."LP_RasterplanAenderung" using gist ("geltungsbereichAenderung");
COMMENT ON TABLE "LP_Raster"."LP_RasterplanAenderung" IS '';
COMMENT ON COLUMN "LP_Raster"."LP_RasterplanAenderung"."gid" IS 'Primärschlüssel, wird automatisch ausgefüllt!';
COMMENT ON COLUMN "LP_Raster"."LP_RasterplanAenderung"."aufstellungbeschlussDatum" IS 'Datum des Aufstellungsbeschlusses';
COMMENT ON COLUMN "LP_Raster"."LP_RasterplanAenderung"."auslegungsDatum" IS 'Datum der öffentlichen Auslegung.';
COMMENT ON COLUMN "LP_Raster"."LP_RasterplanAenderung"."tOeBbeteiligungsDatum" IS 'Datum der Beteiligung der Träger öffentlicher Belange.';
COMMENT ON COLUMN "LP_Raster"."LP_RasterplanAenderung"."aenderungenBisDatum" IS 'Datum bis zu dem Änderungen des Plans berücksichtigt wurden.';
COMMENT ON COLUMN "LP_Raster"."LP_RasterplanAenderung"."entwurfsbeschlussDatum" IS 'Datum des Entwurfsbeschlusses';
COMMENT ON COLUMN "LP_Raster"."LP_RasterplanAenderung"."planbeschlussDatum" IS 'Datum des Planbeschlusses.';
COMMENT ON COLUMN "LP_Raster"."LP_RasterplanAenderung"."inkrafttretenDatum" IS 'Datum des Inkrafttretens des Plans.';
COMMENT ON COLUMN "LP_Raster"."LP_RasterplanAenderung"."sonstVerfahrensDatum" IS 'Sonstiges Verfahrensdatum';
CREATE TRIGGER "change_to_LP_RasterplanAenderung" BEFORE INSERT OR UPDATE ON "LP_Raster"."LP_RasterplanAenderung" FOR EACH ROW EXECUTE PROCEDURE "XP_Raster"."child_of_XP_RasterplanAenderung"();
CREATE TRIGGER "delete_LP_RasterplanAenderung" AFTER DELETE ON "LP_Raster"."LP_RasterplanAenderung" FOR EACH ROW EXECUTE PROCEDURE "XP_Raster"."child_of_XP_RasterplanAenderung"();

-- -----------------------------------------------------
-- Table "LP_Basisobjekte"."LP_Bereich_rasterAenderung"
-- -----------------------------------------------------
CREATE  TABLE  "LP_Basisobjekte"."LP_Bereich_rasterAenderung" (
  "LP_Bereich_gid" BIGINT NOT NULL ,
  "rasterAenderung" BIGINT NOT NULL ,
  PRIMARY KEY ("LP_Bereich_gid", "rasterAenderung") ,
  CONSTRAINT "fk_rasterAenderung_LP_Bereich"
    FOREIGN KEY ("LP_Bereich_gid" )
    REFERENCES "LP_Basisobjekte"."LP_Bereich" ("gid" )
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT "fk_rasterAenderung_LP_RasterplanAenderung"
    FOREIGN KEY ("rasterAenderung" )
    REFERENCES "LP_Raster"."LP_RasterplanAenderung" ("gid" )
    ON DELETE CASCADE
    ON UPDATE CASCADE);

CREATE INDEX "idx_fk_rasterAenderung_LP_Bereich" ON "LP_Basisobjekte"."LP_Bereich_rasterAenderung" ("LP_Bereich_gid") ;
CREATE INDEX "idx_fk_rasterAenderung_LP_RasterplanAenderung" ON "LP_Basisobjekte"."LP_Bereich_rasterAenderung" ("rasterAenderung") ;
GRANT SELECT ON TABLE "LP_Basisobjekte"."LP_Bereich_rasterAenderung" TO xp_gast;
GRANT ALL ON TABLE "LP_Basisobjekte"."LP_Bereich_rasterAenderung" TO lp_user;
...
-- -----------------------------------------------------
-- Table "LP_SchutzgebieteObjekte"."LP_DenkmalschutzrechtDetailTypen"
-- -----------------------------------------------------
...
-- -----------------------------------------------------
-- Table "LP_SchutzgebieteObjekte"."LP_Denkmalschutzrecht"
-- -----------------------------------------------------
CREATE  TABLE  "LP_SchutzgebieteObjekte"."LP_Denkmalschutzrecht" (
  "gid" BIGINT NOT NULL ,
  "detailTyp" INTEGER NULL ,
  PRIMARY KEY ("gid") ,
  CONSTRAINT "fk_LP_Denkmalschutzrecht_detailTyp1"
    FOREIGN KEY ("detailTyp" )
    REFERENCES "LP_SchutzgebieteObjekte"."LP_DenkmalschutzrechtDetailTypen" ("Code" )
    ON DELETE NO ACTION
    ON UPDATE CASCADE,
  CONSTRAINT "fk_LP_Denkmalschutzrecht_parent"
    FOREIGN KEY ("gid" )
    REFERENCES "LP_Basisobjekte"."LP_Objekt" ("gid" )
    ON DELETE CASCADE
    ON UPDATE CASCADE);

GRANT SELECT ON TABLE "LP_SchutzgebieteObjekte"."LP_Denkmalschutzrecht" TO xp_gast;
GRANT ALL ON TABLE "LP_SchutzgebieteObjekte"."LP_Denkmalschutzrecht" TO lp_user;
COMMENT ON TABLE  "LP_SchutzgebieteObjekte"."LP_Denkmalschutzrecht" IS 'Gebiete und Gebietsteile mit rechtlichen Bindungen nach anderen Fachgesetzen (soweit sie für den Schutz, die Pflege und die Entwicklung von Natur und Landschaft bedeutsam sind). Hier:  Flächen die dem Denkmalschutz unterliegen.';
COMMENT ON COLUMN  "LP_SchutzgebieteObjekte"."LP_Denkmalschutzrecht"."gid" IS 'Primärschlüssel, wird automatisch ausgefüllt!';
COMMENT ON COLUMN  "LP_SchutzgebieteObjekte"."LP_Denkmalschutzrecht"."detailTyp" IS 'Typ des Schutzobjektes';
CREATE INDEX "idx_fk_LP_Denkmalschutzrecht_detailTyp" ON "LP_SchutzgebieteObjekte"."LP_Denkmalschutzrecht" ("detailTyp") ;
CREATE TRIGGER "change_to_LP_Denkmalschutzrecht" BEFORE INSERT OR UPDATE ON "LP_SchutzgebieteObjekte"."LP_Denkmalschutzrecht" FOR EACH ROW EXECUTE PROCEDURE "XP_Basisobjekte"."child_of_XP_Objekt"();
CREATE TRIGGER "delete_LP_Denkmalschutzrecht" AFTER DELETE ON "LP_SchutzgebieteObjekte"."LP_Denkmalschutzrecht" FOR EACH ROW EXECUTE PROCEDURE "XP_Basisobjekte"."child_of_XP_Objekt"();

-- -----------------------------------------------------
-- Table "LP_SchutzgebieteObjekte"."LP_DenkmalschutzrechtFlaeche"
-- -----------------------------------------------------
CREATE  TABLE  "LP_SchutzgebieteObjekte"."LP_DenkmalschutzrechtFlaeche" (
  "gid" BIGINT NOT NULL ,
  PRIMARY KEY ("gid") ,
  CONSTRAINT "fk_LP_DenkmalschutzrechtFlaeche_parent"
    FOREIGN KEY ("gid" )
    REFERENCES "LP_SchutzgebieteObjekte"."LP_Denkmalschutzrecht" ("gid" )
    ON DELETE CASCADE
    ON UPDATE CASCADE)
INHERITS ("LP_Basisobjekte"."LP_Flaechenobjekt");

GRANT SELECT ON TABLE "LP_SchutzgebieteObjekte"."LP_DenkmalschutzrechtFlaeche" TO xp_gast;
GRANT ALL ON TABLE "LP_SchutzgebieteObjekte"."LP_DenkmalschutzrechtFlaeche" TO lp_user;
CREATE INDEX "LP_DenkmalschutzrechtFlaeche_gidx" ON "LP_SchutzgebieteObjekte"."LP_DenkmalschutzrechtFlaeche" using gist ("position");
CREATE TRIGGER "change_to_LP_DenkmalschutzrechtFlaeche" BEFORE INSERT OR UPDATE ON "LP_SchutzgebieteObjekte"."LP_DenkmalschutzrechtFlaeche" FOR EACH ROW EXECUTE PROCEDURE "XP_Basisobjekte"."child_of_XP_Objekt"();
CREATE TRIGGER "delete_LP_DenkmalschutzrechtFlaeche" AFTER DELETE ON "LP_SchutzgebieteObjekte"."LP_DenkmalschutzrechtFlaeche" FOR EACH ROW EXECUTE PROCEDURE "XP_Basisobjekte"."child_of_XP_Objekt"();
CREATE TRIGGER "LP_DenkmalschutzrechtFlaeche_Flaechenobjekt" BEFORE INSERT OR UPDATE ON "LP_SchutzgebieteObjekte"."LP_DenkmalschutzrechtFlaeche" FOR EACH ROW EXECUTE PROCEDURE "XP_Basisobjekte"."positionFollowsRHR"();

-- -----------------------------------------------------
-- Table "LP_SchutzgebieteObjekte"."LP_DenkmalschutzrechtLinie"
-- -----------------------------------------------------
CREATE  TABLE  "LP_SchutzgebieteObjekte"."LP_DenkmalschutzrechtLinie" (
  "gid" BIGINT NOT NULL ,
  PRIMARY KEY ("gid") ,
  CONSTRAINT "fk_LP_DenkmalschutzrechtLinie_parent"
    FOREIGN KEY ("gid" )
    REFERENCES "LP_SchutzgebieteObjekte"."LP_Denkmalschutzrecht" ("gid" )
    ON DELETE CASCADE
    ON UPDATE CASCADE)
...
GRANT SELECT ON TABLE "LP_SchutzgebieteObjekte"."LP_DenkmalschutzrechtLinie" TO xp_gast;
GRANT ALL ON TABLE "LP_SchutzgebieteObjekte"."LP_DenkmalschutzrechtLinie" TO lp_user;
CREATE INDEX "LP_DenkmalschutzrechtLinie_gidx" ON "LP_SchutzgebieteObjekte"."LP_DenkmalschutzrechtLinie" using gist ("position");
CREATE TRIGGER "change_to_LP_DenkmalschutzrechtLinie" BEFORE INSERT OR UPDATE ON "LP_SchutzgebieteObjekte"."LP_DenkmalschutzrechtLinie" FOR EACH ROW EXECUTE PROCEDURE "XP_Basisobjekte"."child_of_XP_Objekt"();
CREATE TRIGGER "delete_LP_DenkmalschutzrechtLinie" AFTER DELETE ON "LP_SchutzgebieteObjekte"."LP_DenkmalschutzrechtLinie" FOR EACH ROW EXECUTE PROCEDURE "XP_Basisobjekte"."child_of_XP_Objekt"();

-- -----------------------------------------------------
-- Table "LP_SchutzgebieteObjekte"."LP_DenkmalschutzrechtPunkt"
-- -----------------------------------------------------
CREATE  TABLE  "LP_SchutzgebieteObjekte"."LP_DenkmalschutzrechtPunkt" (
  "gid" BIGINT NOT NULL ,
  PRIMARY KEY ("gid") ,
  CONSTRAINT "fk_LP_DenkmalschutzrechtPunkt_parent"
    FOREIGN KEY ("gid" )
    REFERENCES "LP_SchutzgebieteObjekte"."LP_Denkmalschutzrecht" ("gid" )
    ON DELETE CASCADE
    ON UPDATE CASCADE)
...
GRANT SELECT ON TABLE "LP_SchutzgebieteObjekte"."LP_DenkmalschutzrechtPunkt" TO xp_gast;
GRANT ALL ON TABLE "LP_SchutzgebieteObjekte"."LP_DenkmalschutzrechtPunkt" TO lp_user;
CREATE INDEX "LP_DenkmalschutzrechtPunkt_gidx" ON "LP_SchutzgebieteObjekte"."LP_DenkmalschutzrechtPunkt" using gist ("position");
CREATE TRIGGER "change_to_LP_DenkmalschutzrechtPunkt" BEFORE INSERT OR UPDATE ON "LP_SchutzgebieteObjekte"."LP_DenkmalschutzrechtPunkt" FOR EACH ROW EXECUTE PROCEDURE "XP_Basisobjekte"."child_of_XP_Objekt"();
CREATE TRIGGER "delete_LP_DenkmalschutzrechtPunkt" AFTER DELETE ON "LP_SchutzgebieteObjekte"."LP_DenkmalschutzrechtPunkt" FOR EACH ROW EXECUTE PROCEDURE "XP_Basisobjekte"."child_of_XP_Objekt"();
...
-- -----------------------------------------------------
-- Table "LP_SchutzgebieteObjekte"."LP_ZweckbestimmungSchutzgebiet"
-- -----------------------------------------------------
CREATE  TABLE  "LP_SchutzgebieteObjekte"."LP_ZweckbestimmungSchutzgebiet" (
  "Code" INTEGER NOT NULL ,
  "Bezeichner" VARCHAR(64) NOT NULL ,
  PRIMARY KEY ("Code") );
GRANT SELECT ON TABLE "LP_SchutzgebieteObjekte"."LP_ZweckbestimmungSchutzgebiet" TO xp_gast;

-- -----------------------------------------------------
-- Table "LP_SchutzgebieteObjekte"."LP_SchutzobjektBundesrecht"
-- -----------------------------------------------------
CREATE  TABLE  "LP_SchutzgebieteObjekte"."LP_SchutzobjektBundesrecht" (
  "gid" BIGINT NOT NULL ,
  "typ" INTEGER NULL ,
  "eigenname" VARCHAR (64) NULL,
  PRIMARY KEY ("gid") ,
  CONSTRAINT "fk_LP_SchutzobjektBundesrecht_typ1"
    FOREIGN KEY ("typ" )
    REFERENCES "LP_SchutzgebieteObjekte"."LP_ZweckbestimmungSchutzgebiet" ("Code" )
    ON DELETE NO ACTION
    ON UPDATE CASCADE,
  CONSTRAINT "fk_LP_SchutzobjektBundesrecht_parent"
    FOREIGN KEY ("gid" )
    REFERENCES "LP_Basisobjekte"."LP_Objekt" ("gid" )
    ON DELETE CASCADE
    ON UPDATE CASCADE);

GRANT SELECT ON TABLE "LP_SchutzgebieteObjekte"."LP_SchutzobjektBundesrecht" TO xp_gast;
GRANT ALL ON TABLE "LP_SchutzgebieteObjekte"."LP_SchutzobjektBundesrecht" TO lp_user;
COMMENT ON TABLE  "LP_SchutzgebieteObjekte"."LP_SchutzobjektBundesrecht" IS 'Schutzgebiete und Schutzobjekte nach Naturschutzrecht im Sinne des 4. Abschnittes des BNatSchG. ';
COMMENT ON COLUMN  "LP_SchutzgebieteObjekte"."LP_SchutzobjektBundesrecht"."gid" IS 'Primärschlüssel, wird automatisch ausgefüllt!';
COMMENT ON COLUMN  "LP_SchutzgebieteObjekte"."LP_SchutzobjektBundesrecht"."typ" IS 'Typ des Schutzobjektes';
COMMENT ON COLUMN  "LP_SchutzgebieteObjekte"."LP_SchutzobjektBundesrecht"."eigenname" IS 'Eigennahme des Schutzgebietes.';
CREATE INDEX "idx_fk_LP_SchutzobjektBundesrecht_typ" ON "LP_SchutzgebieteObjekte"."LP_SchutzobjektBundesrecht" ("typ") ;
CREATE TRIGGER "change_to_LP_SchutzobjektBundesrecht" BEFORE INSERT OR UPDATE ON "LP_SchutzgebieteObjekte"."LP_SchutzobjektBundesrecht" FOR EACH ROW EXECUTE PROCEDURE "XP_Basisobjekte"."child_of_XP_Objekt"();
CREATE TRIGGER "delete_LP_SchutzobjektBundesrecht" AFTER DELETE ON "LP_SchutzgebieteObjekte"."LP_SchutzobjektBundesrecht" FOR EACH ROW EXECUTE PROCEDURE "XP_Basisobjekte"."child_of_XP_Objekt"();

-- -----------------------------------------------------
-- Table "LP_SchutzgebieteObjekte"."LP_SchutzobjektBundesrechtFlaeche"
-- -----------------------------------------------------
CREATE  TABLE  "LP_SchutzgebieteObjekte"."LP_SchutzobjektBundesrechtFlaeche" (
  "gid" BIGINT NOT NULL ,
  PRIMARY KEY ("gid") ,
  CONSTRAINT "fk_LP_SchutzobjektBundesrechtFlaeche_parent"
    FOREIGN KEY ("gid" )
    REFERENCES "LP_SchutzgebieteObjekte"."LP_SchutzobjektBundesrecht" ("gid" )
    ON DELETE CASCADE
    ON UPDATE CASCADE)
INHERITS ("LP_Basisobjekte"."LP_Flaechenobjekt");

GRANT SELECT ON TABLE "LP_SchutzgebieteObjekte"."LP_SchutzobjektBundesrechtFlaeche" TO xp_gast;
GRANT ALL ON TABLE "LP_SchutzgebieteObjekte"."LP_SchutzobjektBundesrechtFlaeche" TO lp_user;
CREATE INDEX "LP_SchutzobjektBundesrechtFlaeche_gidx" ON "LP_SchutzgebieteObjekte"."LP_SchutzobjektBundesrechtFlaeche" using gist ("position");
CREATE TRIGGER "change_to_LP_SchutzobjektBundesrechtFlaeche" BEFORE INSERT OR UPDATE ON "LP_SchutzgebieteObjekte"."LP_SchutzobjektBundesrechtFlaeche" FOR EACH ROW EXECUTE PROCEDURE "XP_Basisobjekte"."child_of_XP_Objekt"();
CREATE TRIGGER "delete_LP_SchutzobjektBundesrechtFlaeche" AFTER DELETE ON "LP_SchutzgebieteObjekte"."LP_SchutzobjektBundesrechtFlaeche" FOR EACH ROW EXECUTE PROCEDURE "XP_Basisobjekte"."child_of_XP_Objekt"();
CREATE TRIGGER "LP_SchutzobjektBundesrechtFlaeche_Flaechenobjekt" BEFORE INSERT OR UPDATE ON "LP_SchutzgebieteObjekte"."LP_SchutzobjektBundesrechtFlaeche" FOR EACH ROW EXECUTE PROCEDURE "XP_Basisobjekte"."positionFollowsRHR"();

-- -----------------------------------------------------
-- Table "LP_SchutzgebieteObjekte"."LP_SchutzobjektBundesrechtLinie"
-- -----------------------------------------------------
CREATE  TABLE  "LP_SchutzgebieteObjekte"."LP_SchutzobjektBundesrechtLinie" (
  "gid" BIGINT NOT NULL ,
  PRIMARY KEY ("gid") ,
  CONSTRAINT "fk_LP_SchutzobjektBundesrechtLinie_parent"
    FOREIGN KEY ("gid" )
    REFERENCES "LP_SchutzgebieteObjekte"."LP_SchutzobjektBundesrecht" ("gid" )
    ON DELETE CASCADE
    ON UPDATE CASCADE)
...
GRANT SELECT ON TABLE "LP_SchutzgebieteObjekte"."LP_SchutzobjektBundesrechtLinie" TO xp_gast;
GRANT ALL ON TABLE "LP_SchutzgebieteObjekte"."LP_SchutzobjektBundesrechtLinie" TO lp_user;
CREATE INDEX "LP_SchutzobjektBundesrechtLinie_gidx" ON "LP_SchutzgebieteObjekte"."LP_SchutzobjektBundesrechtLinie" using gist ("position");
CREATE TRIGGER "change_to_LP_SchutzobjektBundesrechtLinie" BEFORE INSERT OR UPDATE ON "LP_SchutzgebieteObjekte"."LP_SchutzobjektBundesrechtLinie" FOR EACH ROW EXECUTE PROCEDURE "XP_Basisobjekte"."child_of_XP_Objekt"();
CREATE TRIGGER "delete_LP_SchutzobjektBundesrechtLinie" AFTER DELETE ON "LP_SchutzgebieteObjekte"."LP_SchutzobjektBundesrechtLinie" FOR EACH ROW EXECUTE PROCEDURE "XP_Basisobjekte"."child_of_XP_Objekt"();

-- -----------------------------------------------------
-- Table "LP_SchutzgebieteObjekte"."LP_SchutzobjektBundesrechtPunkt"
-- -----------------------------------------------------
CREATE  TABLE  "LP_SchutzgebieteObjekte"."LP_SchutzobjektBundesrechtPunkt" (
  "gid" BIGINT NOT NULL ,
  PRIMARY KEY ("gid") ,
  CONSTRAINT "fk_LP_SchutzobjektBundesrechtPunkt_parent"
    FOREIGN KEY ("gid" )
    REFERENCES "LP_SchutzgebieteObjekte"."LP_SchutzobjektBundesrecht" ("gid" )
    ON DELETE CASCADE
    ON UPDATE CASCADE)
...
GRANT SELECT ON TABLE "LP_SchutzgebieteObjekte"."LP_SchutzobjektBundesrechtPunkt" TO xp_gast;
GRANT ALL ON TABLE "LP_SchutzgebieteObjekte"."LP_SchutzobjektBundesrechtPunkt" TO lp_user;
CREATE INDEX "LP_SchutzobjektBundesrechtPunkt_gidx" ON "LP_SchutzgebieteObjekte"."LP_SchutzobjektBundesrechtPunkt" using gist ("position");
CREATE TRIGGER "change_to_LP_SchutzobjektBundesrechtPunkt" BEFORE INSERT OR UPDATE ON "LP_SchutzgebieteObjekte"."LP_SchutzobjektBundesrechtPunkt" FOR EACH ROW EXECUTE PROCEDURE "XP_Basisobjekte"."child_of_XP_Objekt"();
CREATE TRIGGER "delete_LP_SchutzobjektBundesrechtPunkt" AFTER DELETE ON "LP_SchutzgebieteObjekte"."LP_SchutzobjektBundesrechtPunkt" FOR EACH ROW EXECUTE PROCEDURE "XP_Basisobjekte"."child_of_XP_Objekt"();
...
-- -----------------------------------------------------
-- Data for table "LP_SchutzgebieteObjekte"."LP_ZweckbestimmungSchutzgebiet"
-- -----------------------------------------------------
INSERT INTO "LP_SchutzgebieteObjekte"."LP_ZweckbestimmungSchutzgebiet" ("Code", "Bezeichner") VALUES (1000, 'Naturschutzgebiet');
INSERT INTO "LP_SchutzgebieteObjekte"."LP_ZweckbestimmungSchutzgebiet" ("Code", "Bezeichner") VALUES (1100, 'Nationalpark');
INSERT INTO "LP_SchutzgebieteObjekte"."LP_ZweckbestimmungSchutzgebiet" ("Code", "Bezeichner") VALUES (1200, 'Biosphaerenreservat');
INSERT INTO "LP_SchutzgebieteObjekte"."LP_ZweckbestimmungSchutzgebiet" ("Code", "Bezeichner") VALUES (1300, 'Landschaftsschutzgebiet');
INSERT INTO "LP_SchutzgebieteObjekte"."LP_ZweckbestimmungSchutzgebiet" ("Code", "Bezeichner") VALUES (1400, 'Naturpark');
INSERT INTO "LP_SchutzgebieteObjekte"."LP_ZweckbestimmungSchutzgebiet" ("Code", "Bezeichner") VALUES (1500, 'Naturdenkmal');
INSERT INTO "LP_SchutzgebieteObjekte"."LP_ZweckbestimmungSchutzgebiet" ("Code", "Bezeichner") VALUES (1600, 'GeschuetzterLandschaftsBestandteil');
INSERT INTO "LP_SchutzgebieteObjekte"."LP_ZweckbestimmungSchutzgebiet" ("Code", "Bezeichner") VALUES (1700, 'GesetzlichGeschuetztesBiotop');
INSERT INTO "LP_SchutzgebieteObjekte"."LP_ZweckbestimmungSchutzgebiet" ("Code", "Bezeichner") VALUES (1800, 'GebietGemeinschaftlicherBedeutung');
INSERT INTO "LP_SchutzgebieteObjekte"."LP_ZweckbestimmungSchutzgebiet" ("Code", "Bezeichner") VALUES (1900, 'EuropaeischesVogelschutzgebiet');
